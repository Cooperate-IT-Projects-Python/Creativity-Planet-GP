  ...
  return (
    <>
      <section className='head'>
        ...
        <a href="https://www.facebook.com/creativityplanet8" target="_blank"><i className='fab fa-facebook-f icon'></i></a>
            <a href="https://www.youtube.com/channel/UCh2_FImPlbQWQy9oVN9MTlA" target="_blank"><i className='fab fa-youtube icon'></i></a>
            <a href="https://www.instagram.com/creativity_planet_academy/" target="_blank"><i className='fab fa-instagram icon'></i></a>
          </div>
